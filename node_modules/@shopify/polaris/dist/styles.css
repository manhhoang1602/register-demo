@charset "UTF-8";
:root{ --polaris-version-number:'6.3.0'; --polaris-animation-skeleton-shimmer:polaris-SkeletonShimmerAnimation; }
...
.Polaris-IndexTable__TableRow--hovered, .Polaris-IndexTable__TableRow--hovered .Polaris-IndexTable__TableCell--first, .Polaris-IndexTable__TableRow--hovered .Polaris-IndexTable__TableCell--first + .Polaris-IndexTable__TableCell{ background-color:var(--p-surface-selected-hovered); }

.Polaris-IndexTable__SubTableRow, .Polaris-IndexTable__SubTableRow .Polaris-IndexTable__TableCell--first, .Polaris-IndexTable__SubTableRow .Polaris-IndexTable__TableCell--first + .Polaris-IndexTable__TableCell{ background-color:var(--p-surface-subdued); }

.Polaris-IndexTable__TableRow--selected, .Polaris-IndexTable__TableRow--selected .Polaris-IndexTable__TableHeading--first, .Polaris-IndexTable__TableRow--selected .Polaris-IndexTable__TableHeading--second, .Polaris-IndexTable__TableRow--selected .Polaris-IndexTable__TableCell--first, .Polaris-IndexTable__TableRow--selected .Polaris-IndexTable__TableCell--first + .Polaris-IndexTable__TableCell{ background-color:var(--p-surface-selected); }
